...
export class ShortInfoComponent implements OnInit {
  ...
  calculateMetrics(data: any[]): any {
    // Опишіть тут логіку обчислення метрик за вашими вимогами
    // Використовуйте методи масиву та RxJS для групування даних та обчислення метрик
    // Поверніть об'єкт з обчисленими метриками
  }
}
